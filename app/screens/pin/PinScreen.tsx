...
export default function PinScreen() {
    ...
    const source = route.params?.source || 'Airtime' || 'Data';  // Receive the 'source' from navigation params
        ...
        renderItem={() => (
          <View style={styles.screen}>
            ...
            <StatusModal
              ...
              amount={amount}
              source={source}  // Pass the source here
            />
          </View>
        )}
